package com.ecommerce.itemservice.grpcserver;
...
public class ItemServerService extends IdServiceGrpc.IdServiceImplBase {
    ...
    public void getId(final IdRequest req, final StreamObserver<IdReply> responseObserver) {
        ...
        int id  = itemSearchingService.findByItemName(req_val).getItemId();
